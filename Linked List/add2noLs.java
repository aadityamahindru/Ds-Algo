...
public class Main {
  ...
  public static class LinkedList {
    ...
    private static int addTwoListsHelper(Node l1,int p1,Node l2,int p2,LinkedList ans){
        if(p1==0&&p2==0){
            return 0;
        }
        if(p1>p2){
            int carry = addTwoListsHelper(l1.next,p1-1,l2,p2,ans);
            int val=carry+l1.data;
            ans.addFirst(val%10);
            return val/10;
        }else if(p2>p1){
            int carry = addTwoListsHelper(l1,p1,l2.next,p2-1,ans);
            int val=carry+l2.data;
            ans.addFirst(val%10);
            return val/10;
        }else{
            int carry = addTwoListsHelper(l1.next,p1-1,l2.next,p2-1,ans);
